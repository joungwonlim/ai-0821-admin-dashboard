...
export type subscription_schedules_resource_default_settings_automatic_tax = {
     ...
     */
    disabled_reason?: subscription_schedules_resource_default_settings_automatic_tax.disabled_reason | null;
    /**
...
export namespace subscription_schedules_resource_default_settings_automatic_tax {
    /**
     * If Stripe disabled automatic tax, this enum describes why.
     */
