...
export type treasury_received_credits_resource_reversal_details = {
     ...
     */
    restricted_reason?: treasury_received_credits_resource_reversal_details.restricted_reason | null;
};
export namespace treasury_received_credits_resource_reversal_details {
    /**
     * Set if a ReceivedCredit cannot be reversed.
     */
