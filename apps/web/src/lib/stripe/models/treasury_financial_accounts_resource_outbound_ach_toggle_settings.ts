...
export type treasury_financial_accounts_resource_outbound_ach_toggle_settings = {
     ...
     */
    status: treasury_financial_accounts_resource_outbound_ach_toggle_settings.status;
    /**
     * Additional details; includes at least one entry when the status is not `active`.
     */
    status_details: Array<treasury_financial_accounts_resource_toggles_setting_status_details>;
};
export namespace treasury_financial_accounts_resource_outbound_ach_toggle_settings {
    /**
     * Whether the Feature is operational.
     */
    export enum status {
