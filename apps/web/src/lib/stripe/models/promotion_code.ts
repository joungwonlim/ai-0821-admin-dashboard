...
import type { promotion_codes_resource_restrictions } from './promotion_codes_resource_restrictions';
/**
...
export namespace promotion_code {
    /**
     * String representing the object's type. Objects of the same type share the same value.
     */
    export enum object {
